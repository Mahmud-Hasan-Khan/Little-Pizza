      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="text-center md:text-left mb-8 md:mb-0">
            <h3 className="text-2xl font-bold">Little Pizza</h3>
            <p className="mt-2 text-gray-600">3315 Junction Blvd, Flushing, New York 11372</p>
            <p className="text-gray-600">(718) 899-9899</p>
          </div>
